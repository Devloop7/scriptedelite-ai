...
class AppConfig:
    ...
    # Enemy color filter (Color / Hybrid color path) — only track this color
    enemy_color: str = "#FF00FA"         # hex RRGGBB of enemy outline / nameplate
    color_tolerance: float = 55.0        # 5-100 match looseness
